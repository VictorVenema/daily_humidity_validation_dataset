function plot_comparison_data_surrogate

plotAllNew = 1; 
plotCrossCorrelationsNew = 1;
plotCrossSeasonalNew = 1;
plotScatterNew = 1;
plotCDFNew = 1;
plotACFNew = 1;
...
%         ax(3) = 1100; ax(4) = 880;
    ...
    %         crosscorrData = corrcoef(data);
            index = find(dateSurr.month == iMonth );
            crosscorrSurr = corrcoef(surr(index,:)); %#ok<FNDSB>
...
%             ax(3) = 700;        
            ...
            for iStat = 1:noStations
                ...
                acfSurr = xcorr(surrStation, maxlags, 'coeff');            
                subplot(3,2,iStat)
